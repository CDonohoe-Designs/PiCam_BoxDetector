...
def index():
    try:
        ...
        links = {"video": "/video","video_raw": "/video_raw","snapshot": "/snapshot","health": "/health","config": "/config"}
    html = f"""
    <!doctype html>
    <html lang=\"en\">
    <head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><title>PiCam Box Detector (YOLO)</title>
    <style>body{font-family:system-ui,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;margin:24px}h1{margin-bottom:8px}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:12px;margin:16px 0}.card{border:1px solid #ddd;border-radius:12px;padding:12px 14px;box-shadow:0 1px 2px rgba(0,0,0,.04)}a{text-decoration:none}.mono{font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:12px;white-space:pre-wrap}.tag{display:inline-block;padding:2px 8px;border-radius:999px;background:#f2f4f7;font-size:12px}</style>
    </head>
    <body>
      <h1>PiCam Box Detector <span class=\"tag\">YOLO</span></h1>
      <div class=\"grid\">
        <div class=\"card\"><a href=\"{links['video\']}\">/video</a><div class=\"mono\">MJPEG with detections & HUD</div></div>
        <div class=\"card\"><a href=\"{links['video_raw\']}\">/video_raw</a><div class=\"mono\">MJPEG without detection</div></div>
        <div class=\"card\"><a href=\"{links['snapshot\']}\">/snapshot</a><div class=\"mono\">Save before/after images</div></div>
        <div class=\"card\"><a href=\"{links['health\']}\">/health</a><div class=\"mono\">Service health</div></div>
        <div class=\"card\"><a href=\"{links['config\']}\">/config</a><div class=\"mono\">Runtime configuration JSON</div></div>
      </div>
    </body>
    </html>
    """
